...
<h2>Hi there,</h2>
<p>this is a <em>basic</em> example of <strong>Tiptap</strong>. <mark>Sure, there are all kind of basic text styles you’d probably expect from a text editor.</mark> But wait until you see the lists:</p>
<ul>
